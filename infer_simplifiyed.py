...
superpoint_model_path = "output/rknn/superpoint_simplified_512_256_rk3588.rknn"
# lightglue_model_path = "output/rknn/lightglue_512_256_rk3588.rknn"
lightglue_model_path = "output/rknn/lightglue_simplified_512_256_rk3588.rknn"
...
print(f"superpoint_model 耗时: {time.perf_counter() - star_infer:.6f} 秒")
...
lg_inputs = [
kpts0.astype(np.float16),  # (1, 256, 2)
kpts1.astype(np.float16),  # (1, 256, 2)
desc0.astype(np.float16), # (1, 256, 256)
desc1.astype(np.float16)  # (1, 256, 256)
]
